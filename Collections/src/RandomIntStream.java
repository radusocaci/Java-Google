...
public class RandomIntStream
{
   public static void main(String[] args)
   {
      ...
      random.ints(6_000_000, 1, 7) // generates as IntStream of 6m elements between [1,7)
            .boxed() // convert IntStream to Stream<Integer>
            .collect(Collectors.groupingBy(Function.identity(), // function that simply returns its argument
               Collectors.counting()))
