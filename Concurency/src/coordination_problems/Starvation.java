...
/**
 * Starvation:In Starvation, threads are also waiting for each other. But here waiting time is not infinite after some interval of time,
 * waiting thread always gets the resources whatever is required to execute thread run() method.
 */
